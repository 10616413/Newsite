...
namespace NewsiteA.Controllers
{
    public class ArticleController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ReleaseDate,Genre,Text")] Article article)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ReleaseDate,Genre,Text")] Article article)
        {
            if (id != article.Id)
            {
                return NotFound();
